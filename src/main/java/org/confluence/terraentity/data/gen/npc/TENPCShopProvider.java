...
public class TENPCShopProvider extends AbstractExistCodecProvider<NPCTradeManager> {
    ...
    protected void run(HolderLookup.Provider lookupProvider) {
        ...
        shop(TENpcEntities.DEMOLITIONIST.getId(),builder()
                ...
                .add(ItemTradeItemList.builder().addCost(Items.GUNPOWDER,1).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 1, stack -> FireworkRocketItem.setDuration(stack, (byte)1))).build())
                .add(ItemTradeItemList.builder().addCost(Items.GUNPOWDER,2).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 1, stack -> FireworkRocketItem.setDuration(stack, (byte)2))).build())
                .add(ItemTradeItemList.builder().addCost(Items.GUNPOWDER,2).addCost(Items.COAL, 1).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 1, stack -> FireworkRocketItem.setDuration(stack, (byte)3))).build())
                .build());
        ...
        shop(TENpcEntities.NURSE.getId(),builder()
                ...
                .add(ItemTradeItemList.builder().addCost(Items.RED_MUSHROOM,1).addCost(Items.BROWN_MUSHROOM,1).addResult(TEItemUtil.make(Items.POTION, 1, stack -> PotionUtils.setPotion(stack, Potions.HEALING))).build())
                .add(ItemTradeItemList.builder().addCost(Items.RED_MUSHROOM,1).addCost(Items.BROWN_MUSHROOM,1).addCost(Items.WARPED_FUNGUS, 1).addResult(TEItemUtil.make(Items.POTION, 1, stack -> PotionUtils.setPotion(stack, Potions.STRONG_HEALING))).build())
                .build());
        ...
        shop(TENpcEntities.ANGLER.getId(),builder()
                .add(TradeTask.create(
                        DynamicAnglerTradeTask.builder(
                                ...
                                .addResult(10, List.of(TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_LUCK,1)), TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_SPEED,1))))
                                .addResult(15, List.of(TEItemUtil.make(Items.IRON_INGOT,20)))
                                .addResult(20, List.of(TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_LUCK,2)),TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_SPEED,2))))
                                .addResult(25, List.of(TEItemUtil.make(Items.GOLD_INGOT,20)))
                                .addResult(30, List.of(TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_LUCK,3)),TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.FISHING_SPEED,3))))
                                .addResult(35, List.of(TEItemUtil.make(Items.DIAMOND,20)))
                                .addResult(40, List.of(TEItemUtil.make(Items.ENCHANTED_BOOK, 1, stack-> stack.enchant(Enchantments.MENDING,1))))
                                .addResult(45, List.of(TEItemUtil.make(Items.EMERALD,20)))
                                .addResult(50, List.of(TEItemUtil.make(Items.NETHERITE_INGOT,5), TEItemUtil.make(TEBoomerangItems.FLAMARANG.get(), 1, stack->stack.enchant(TEEnchantments.MULTI_BOOMERANG.get(),1))))
...
//                                .setTitle("title.terra_entity.npc_trade.task.fishman")
        ...
        shop(TENpcEntities.ARMS_DEALER.getId(),builder()
                ...
                .add(ItemTradeItemList.builder().addCost(Items.ARROW, 4).addCost(Items.SPIDER_EYE, 1).addResult(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> PotionUtils.setPotion(stack, Potions.POISON))).build())
                .add(ItemTradeItemList.builder().addCost(Items.ARROW, 4).addCost(Items.SPIDER_EYE, 1).addResult(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> PotionUtils.setPotion(stack, Potions.SLOWNESS))).build())
                .add(ItemTradeItemList.builder().addCost(Items.ARROW, 4).addCost(Items.PHANTOM_MEMBRANE, 1).addResult(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> PotionUtils.setPotion(stack, Potions.SLOW_FALLING))).build())
        ...
        shop(TENpcEntities.WITCH_DOCTOR.getId(), builder()
                ...
                .add(ItemTradeItemList.builder().addCost(Items.EMERALD).addResult(TEItemUtil.make(Items.SPLASH_POTION, 1, stack -> PotionUtils.setPotion(stack, Potions.HEALING))).build())
                .add(ItemTradeItemList.builder().addCost(Items.EMERALD).addResult(TEItemUtil.make(Items.SPLASH_POTION, 1, stack -> PotionUtils.setPotion(stack, Potions.HARMING))).build())
        ...
        shop(TENpcEntities.PARTY_GIRL.getId(), builder()
                .add(ItemTradeItemList.builder().addCost(Items.EMERALD).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 3, stack ->
                {
                    FireworkRocketItem.setDuration(stack, (byte) 1);
                    FireworkRocketItem.Shape.STAR.save(stack.getOrCreateTag());
                }
                )).build())
                .add(ItemTradeItemList.builder().addCost(Items.EMERALD).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 3, stack -> {
                    FireworkRocketItem.setDuration(stack, (byte) 1);
                    FireworkRocketItem.Shape.CREEPER.save(stack.getOrCreateTag());
                })).build())
                .add(ItemTradeItemList.builder().addCost(Items.EMERALD).addResult(TEItemUtil.make(Items.FIREWORK_ROCKET, 3, stack -> {
                    FireworkRocketItem.setDuration(stack, (byte) 1);
                    FireworkRocketItem.Shape.BURST.save(stack.getOrCreateTag());
                })).build())
