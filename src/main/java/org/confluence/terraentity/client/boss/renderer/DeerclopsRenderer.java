...
public class DeerclopsRenderer extends GeoNormalRenderer<Deerclops> {
    ...
    public void reRender(BakedGeoModel model, PoseStack poseStack, MultiBufferSource bufferSource, Deerclops animatable,
        ...
        poseStack.pushPose();
        actuallyRender(poseStack, animatable, model, renderType, bufferSource, buffer, true, partialTick, packedLight, packedOverlay, r, g, b, a);
        postRender(poseStack, animatable, model, bufferSource, buffer, true, partialTick, packedLight, packedOverlay, r, g, b, a);
        poseStack.popPose();
    }
