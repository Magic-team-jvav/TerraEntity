...
public class WyvernBodyRenderer<S extends BaseWormPart> extends GeoWormSegmentRenderer<S, WyvernRenderer> {
    ...
    @Override
    public void preRender(PoseStack poseStack, S animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float r, float g, float b, float a) {
