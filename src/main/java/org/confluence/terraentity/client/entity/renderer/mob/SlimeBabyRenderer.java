...
public class SlimeBabyRenderer extends GeoNormalRenderer<SummonSlime> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, SummonSlime animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float r, float g, float b, float a) {
