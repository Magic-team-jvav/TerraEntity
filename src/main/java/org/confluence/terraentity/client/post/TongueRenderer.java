...
public class TongueRenderer {
    ...
    public static void renderFirstPerson(RenderLevelStageEvent event) {
        ...
        for (Player player : Minecraft.getInstance().level.players()) {
            if (!player.hasEffect(TEEffects.THE_TONGUE.get())) continue;
            if (player.getEffect(TEEffects.THE_TONGUE.get()) == null) continue;

            MobEffect rawEffect = player.getEffect(TEEffects.THE_TONGUE.get()).getEffect();
    ...
    public static void render(RenderLivingEvent event) {
        ...
        if (livingEntity.hasEffect(TEEffects.THE_TONGUE.get()) && livingEntity.getEffect(TEEffects.THE_TONGUE.get()) != null) {
