...
public enum DebugEntityHelper{
    ...
    private boolean shouldRender() {
        ...
        if(it.getItem() instanceof BossSummonsItem<?> summonsItem) {
            ...
            Vec3 eyePos = summonsItem.getSummonPos(Minecraft.getInstance().player, Minecraft.getInstance().getDeltaFrameTime());
            e.setPos(eyePos);
    ...
    public void render(RenderLevelStageEvent event){
        ...
        if(render instanceof GeoNormalRenderer geoRenderer){
            ...
            geoRenderer.setConsumeColor(new Color(0x80FFFFFF));
