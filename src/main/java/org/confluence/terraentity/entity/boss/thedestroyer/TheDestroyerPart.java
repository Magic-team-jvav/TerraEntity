...
public class TheDestroyerPart extends AbstractTerraBossBase implements Boss.BossPart {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_PROBE_RELEASED, false);
        this.entityData.define(DATA_FLAPS_OPEN, false);
        this.entityData.define(DATA_SEGMENT_ROLL, 0f);
        this.entityData.define(DATA_IS_TAIL, false);
        this.entityData.define(DATA_IS_PROBE_SEGMENT, false);
    }
        ...
        if (!level().isClientSide && !hasReleasedProbe() && owner != null) {
            ...
            if (level() instanceof ServerLevel sl) {
                ...
                if (probe != null) {
                    ...
                    probe.finalizeSpawn(sl, sl.getCurrentDifficultyAt(blockPosition()), MobSpawnType.TRIGGERED, null, null);
