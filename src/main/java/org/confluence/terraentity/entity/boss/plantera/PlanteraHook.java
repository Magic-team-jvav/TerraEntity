...
public class PlanteraHook extends AbstractPlanteraTentacleSrc implements Boss {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_HOOK_NUM, OptionalInt.empty());
        this.entityData.define(DATA_STATE, OptionalInt.empty());
        this.entityData.define(DATA_TARGET_BLOCK, Optional.empty());
    }
