...
public class TheTwins extends AbstractTerraBossBase implements Boss {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_SPAZMATISM_ID, 0);
        this.entityData.define(DATA_RETINAZER_ID, 0);
    }
    ...
    @Override
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData,  @javax.annotation.Nullable CompoundTag pDataTag) {
