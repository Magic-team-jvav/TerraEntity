...
public class SummonFollowOwnerGoal<T extends Mob & ISummonMob> extends Goal {
    ...
    public SummonFollowOwnerGoal(T tamable, double speedModifier, float stopDistance, boolean canFly) {
    ...
    public boolean canUse() {
        ...
        if (livingentity == null) {
            ...
            return false;
        } else if (this.tamable.distanceToSqr(livingentity) < tamable.summon_getStartDistanceToOwner()) {
            return false;
        } else {
    ...
    public void tick() {
        ...
        if (--this.timeToRecalcPath <= 0) {
            ...
            if (flag) {
                this.tamable.summon_tryToTeleportToOwner(canFly);
            } else {
                createPath();
            }
        }
