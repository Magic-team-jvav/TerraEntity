...
public class TEMonsterEntities {
    ...
    public static final RegistryObject<EntityType<BaseSlime>> CRIMSLIME = registerSlime("crimson_slime", 0x8B4949, 2);
    ...
    public static final RegistryObject<EntityType<Piranha>> SHARK = TEEntities.registerMonster(ENTITIES, "shark", Piranha::new, 2.5F, 1F);
    ...
    // 蠕虫
    public static final RegistryObject<EntityType<BaseWorm<BaseWormPart>>> DEVOURER = TEEntities.registerMonster(ENTITIES, "devourer", (e, l) -> BaseWorm.simpleWorm(e, l, AbstractPrefab.WARM_BUILDER.get().setSpawnWithoutLight()), 2F, 2F);
    ...
    // 哥布林军队
    public static final RegistryObject<EntityType<HumanoidMonster>> GOBLIN_ARCHER = TEEntities.registerMonster(ENTITIES, "goblin_archer", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setMainHand(Items.BOW.getDefaultInstance()).setSpawnWithoutLight()), 0.65F, 1.85F);
    public static final RegistryObject<EntityType<HumanoidMonster>> GOBLIN_PEON = TEEntities.registerMonster(ENTITIES, "goblin_peon", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setSpawnWithoutLight()), 0.65F, 1.85F);
    public static final RegistryObject<EntityType<HumanoidMonster>> GOBLIN_WARRIOR = TEEntities.registerMonster(ENTITIES, "goblin_warrior", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setMainHand(Items.STONE_SWORD.getDefaultInstance()).setSpawnWithoutLight()), 0.65F, 1.85F);
    public static final RegistryObject<EntityType<HumanoidMonster>> GOBLIN_THIEF = TEEntities.registerMonster(ENTITIES, "goblin_thief", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setSpawnWithoutLight()), 0.65F, 1.85F);
    public static final RegistryObject<EntityType<HumanoidMonster>> GOBLIN_SCOUT = TEEntities.registerMonster(ENTITIES, "goblin_scout", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setSpawnWithoutLight()), 0.65F, 1.85F);
    public static final RegistryObject<EntityType<HumanoidMonster>> ANGER_GOBLIN = TEEntities.registerMonster(ENTITIES, "anger_goblin", (e, l) -> new HumanoidMonster(e, l, new AbstractPrefab().asHumanoid().setMainHand(Items.GOLDEN_SWORD.getDefaultInstance()).setSpawnWithoutLight()), 0.65F, 1.85F);
    ...
    public static final RegistryObject<EntityType<Wraith>> WRAITH = TEEntities.registerMonster(ENTITIES, "wraith", (e, l) -> new Wraith(e, l), 1F, 2F);
    ...
    public static final RegistryObject<EntityType<Piranha>> ARAPAIMA = TEEntities.registerMonster(ENTITIES, "arapaima", (e, l) -> new Piranha(e, l), 2.2F, 0.7F);
    public static final RegistryObject<EntityType<JellyFish>> GREEN_JELLYFISH = TEEntities.registerMonster(ENTITIES, "green_jellyfish", (e, l) -> new JellyFish(e, l), 0.5F, 0.5F);
...
//        }
    ...
    public static void registerEntityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(BLACK_SLIME.get(), Monster.createMonsterAttributes()
//                .add(Attributes.WATER_MOVEMENT_EFFICIENCY, BaseSlime.slimeWaterMoveSpeed)
        ...
        event.put(PIXIE.get(), AttBuilder.createAttributes(78, 20, 28, 16, 1, 0.46f).gravity(0).build());
    ...
    public static void spawnPlacementRegister(SpawnPlacementRegisterEvent event) {
        ...
        event.register(DUNGEON_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BaseSlime::checkSlimeSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GREEN_DUMPLING_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, BaseSlime::checkSlimeSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        event.register(SPIKED_ICE_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SPIKED_JUNGLE_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);


        // land
        event.register(BLOOD_CRAWLER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BLOOD_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BLOODY_SPORE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(FACE_MONSTER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SPORE_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SPORE_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(HAT_SPORE_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DECAYEDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GIANT_SHELLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CRAWDAD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(NYMPH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SNATCHER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(MAN_EATER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SNOW_FLINX.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // fly
        event.register(DEMON_EYE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDemonEyeSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(FLYING_FISH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkFlyingFishSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CRIMERA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DRIPPLER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(EATER_OF_SOULS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(HARPY.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkHighLevelMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DEMON.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(VOODOO_DEMON.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(ANTLION_SWARMER.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GIANT_ANTLION_SWARMER.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GRANITE_ELEMENTAL.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(METEOR_HEAD.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // swim
        event.register(PIRANHA.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SHARK.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BLUE_JELLYFISH.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(PINK_JELLYFISH.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GREEN_JELLYFISH.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(WaterAnimal::checkSurfaceWaterAnimalSpawnRules), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(ARAPAIMA.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(WaterAnimal::checkSurfaceWaterAnimalSpawnRules), SpawnPlacementRegisterEvent.Operation.REPLACE);


        // worm
        event.register(DEVOURER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GIANT_WORM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkCaveMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(TOMB_CRAWLER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkCaveMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BONE_SERPENT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(WITHER_BONE_SERPENT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // bee
        event.register(HORNET.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // bat
        event.register(CAVE_BAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(JUNGLE_BAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkRoutineMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(HELL_BAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(ICE_BAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SPORE_BAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // 地牢骷髅
        event.register(BASE_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        event.register(ANGER_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SHORT_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BIG_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BIG_ANGER_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BIG_MUSCLE_ANGER_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BIG_HELMET_ANGER_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkDungeonMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(UNDEAD_VIKING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkUndergroundMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        ...
        event.register(FIRE_IMP.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);


        // 哥布林军队
        event.register(GOBLIN_SORCERER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOBLIN_PEON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOBLIN_ARCHER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOBLIN_WARRIOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOBLIN_THIEF.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOBLIN_SCOUT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGoblinScoutSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(ANGER_GOBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkGroundSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);

        // 本体没有生成但是字模块需要的
        event.register(WANDERING_EYE_FISH.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks::checkNetherMonsterSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
        /* *********肉后***************** */
        event.register(WYVERN.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkHighLevelMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(PIXIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkGroundSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(LUMINOUS_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(POSSESS_ARMOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkPossessArmorSpawnCondition), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(WRAITH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkDemonEyeSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CRIMSLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkGroundSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CORRUPT_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkGroundSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);

        event.register(WOODEN_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GOLDEN_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SHADOW_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkNetherMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(ICE_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CRIMSON_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(CORRUPT_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(HALLOWED_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(JUNGLE_MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkCaveMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);

        event.register(MUMMY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DARK_MUMMY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(BLOOD_MUMMY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(LIGHT_MUMMY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DARK_LAMIA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(LIGHT_LAMIA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(GHOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(TAINTED_GHOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(VILE_GHOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(DREAMER_GHOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(SAND_POACHER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkUndergroundMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);

        event.register(DERPLING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
        event.register(HERPLING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, SpawnPlacementChecks.checkHardmode(SpawnPlacementChecks::checkRoutineMonsterSpawn), SpawnPlacementRegisterEvent.Operation.REPLACE);
