...
public class TEBossEntities {
    ...
    public static final RegistryObject<EntityType<KingSlime>> KING_SLIME = ENTITIES.register("king_slime", () -> EntityType.Builder.<KingSlime>of(KingSlime::new, MobCategory.MONSTER).sized(2.04F, 2.04F).clientTrackingRange(10).build(TEEntities.Key("king_slime")));
    ...
    public static final RegistryObject<EntityType<EyeOfCthulhu>> EYE_OF_CTHULHU = TEEntities.registerMonster(ENTITIES, "eye_of_cthulhu", EyeOfCthulhu::new, 2.04F, 2.04F);
