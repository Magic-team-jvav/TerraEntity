...
//    Color c = new Color(0xFF714C11, true);  // 删掉注释查看颜色
    ...
    public static void registerEntityAttributes(EntityAttributeCreationEvent event) {
        ...
        // sommon
        event.put(SUMMON_FINCH.get(), AbstractSummonMob.createAttributes().add(Attributes.FOLLOW_RANGE, 32).add(Attributes.MOVEMENT_SPEED, 0.7).add(ForgeMod.ENTITY_GRAVITY.get(), 0).add(Attributes.ATTACK_KNOCKBACK, 0).build());
