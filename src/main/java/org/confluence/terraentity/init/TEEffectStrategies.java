...
/// 适用于剑、弹射物、生物命中特效等
///
/// 为使翻译键统一，建议注册 EffectStrategy 使用 private, 复用Components
///
/// @author coffee
public final class TEEffectStrategies {
    ...
    /// @param name   id
    /// @param effect 效果回调
    public static RegistryObject<EffectStrategy> createEffect(String name, BiConsumer<LivingEntity, LivingEntity> effect) {
    ...
    /// @param name   id
    /// @param effect 效果类型
    public static RegistryObject<EffectStrategy> createEffect(String name, IEffectStrategy effect) {
    ...
    /// 蝙蝠棍
    public static final RegistryObject<EffectStrategy> BAT_FANG_EFFECT = createEffect("bat", (owner, entity) -> {
    ...
    public static final RegistryObject<EffectStrategy> HEAL_0_5_EFFECT = createEffect("heal_0_5", (owner, entity) -> {
        if (owner instanceof OwnableEntity o && o.getOwner() != null) {
    ...
    public static final RegistryObject<EffectStrategy> POISON_5_SEC_2_AMP = createEffect("poison_5_sec_2_amp",
            TimePossibilityAmplifierEffect.of("poison_5_sec_2_amp", MobEffectHolder.wrap(MobEffects.POISON), 100, 2, 2, 1f));

    public static final RegistryObject<EffectStrategy> SLOW_5_SEC_2_AMP = createEffect("slow_5_sec_2_amp",
            TimePossibilityAmplifierEffect.of("slow_5_sec_2_amp", MobEffectHolder.wrap(MobEffects.MOVEMENT_SLOWDOWN), 100, 2, 2, 1f));


    public static final RegistryObject<EffectStrategy> FROZEN_EFFECT = createEffect("frozen_burn_5_sec_2_amp",
            TimePossibilityAmplifierEffect.of("frozen_burn_5_sec_2_amp", MobEffectHolder.wrap(TEEffects.FROST_BURN.get()), 100, 2, 2, 1f));

    public static final RegistryObject<EffectStrategy> HELL_FIRE_EFFECT = createEffect("hell_fire_5_sec_2_amp",
            TimePossibilityAmplifierEffect.of("hell_fire_5_sec_2_amp", MobEffectHolder.wrap(TEEffects.HELLFIRE.get()), 5 * 20, 2, 2, 1f));


//    /** 魔光剑*/
//    private static final  RegistryObject<EffectStrategy> LIGHTS_BANE_EFFECT = createEffect("lights_bane",
//            ON_HIT_PROJECTILE.apply((level)->ModEntities.LIGHTS_BANE_PROJECTILE.get().create(level).addAttackDamage(7f)));
//

    public static final RegistryObject<EffectStrategy> YOYO_BEE_PROJ_EFFECT = createEffect("yoyo_bee_proj", (owner, entity) -> {
    ...
    private static final RegistryObject<EffectStrategy> FROST_BURN_10_SEC_4_AMP = createEffect("frozen_burn_10_sec_4_amp",
            TimePossibilityAmplifierEffect.of("frozen_burn_10_sec_4_amp", MobEffectHolder.wrap(TEEffects.FROST_BURN.get()), 200, 3, 3, 1f));

    private static final RegistryObject<EffectStrategy> HELL_FIRE_10_SEC_4_AMP = createEffect("hell_fire_10_sec_4_amp",
            TimePossibilityAmplifierEffect.of("hell_fire_10_sec_4_amp", MobEffectHolder.wrap(TEEffects.HELLFIRE.get()), 200, 3, 3, 1f));

    private static final RegistryObject<EffectStrategy> WITHER_10_SEC_4_AMP = createEffect("wither_10_sec_4_amp",
            TimePossibilityAmplifierEffect.of("wither_10_sec_4_amp", MobEffectHolder.wrap(MobEffects.WITHER), 200, 3, 3, 1f));

    private static final RegistryObject<EffectStrategy> POISON_10_SEC_4_AMP = createEffect("poison_10_sec_4_amp",
            TimePossibilityAmplifierEffect.of("poison_10_sec_4_amp", MobEffectHolder.wrap(MobEffects.POISON), 200, 3, 3, 1f));

    private static final RegistryObject<EffectStrategy> INSTANT_HARM_1_SEC_7_AMP = createEffect("instant_harm_1_sec_7_amp",
            TimePossibilityAmplifierEffect.of("instant_harm_1_sec_7_amp", MobEffectHolder.wrap(MobEffects.HARM), 1, 6, 6, 1f));
    ...
    public static class Components {
        ...
        public static final Supplier<EffectStrategyComponent> FROST_BURN_EFFECT = () -> EffectStrategyComponent.of(
                TimePossibilityAmplifierEffect.of("frozen_burn_5_sec", MobEffectHolder.wrap(TEEffects.FROST_BURN.get()), 10 * 20));

        public static final Supplier<EffectStrategyComponent> FROST_BURN_BOOMERANG_EFFECT = () -> EffectStrategyComponent.of(
                TimePossibilityAmplifierEffect.of("frozen_burn_3_sec_50_chance", MobEffectHolder.wrap(TEEffects.FROST_BURN.get()), 3 * 20, 0, 0.5F));
...
//                TimePossibilityAmplifierEffect.of("tentacle_spikes", ModEffects.TENTACLE_SPIKES, 180, 0, 4, 0.5f));
        ...
        public static final Supplier<EffectStrategyComponent> HUNTING_RIFLE_EFFECT = () -> EffectStrategyComponent.of(
                TimePossibilityAmplifierEffect.of("hunting_4_sec", MobEffectHolder.wrap(TEEffects.SUMMON_FOCUS.get()), 160));

        /// 火山
        public static final Supplier<EffectStrategyComponent> HELL_FIRE_EFFECT = () -> new EffectStrategyComponent(List.of(
                TimePossibilityAmplifierEffect.of("hell_fire_5_sec", MobEffectHolder.wrap(TEEffects.HELLFIRE.get()), 5 * 20),
...
//                ModEffectStrategies.BEE_KEEPER_EFFECT);
        ...
        /// 北斗飞镖
        public static final Supplier<EffectStrategyComponent> BEI_DOU_EFFECT = () -> EffectStrategyComponent.of(new RandomWeightEffect("bei_dou", () -> Map.of(
