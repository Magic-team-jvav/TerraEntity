...
public class DynamicAnglerTradeTask implements ITradeTask {
    public static final MapCodec<DynamicAnglerTradeTask> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            Codec.unboundedMap(TECodecs.INT_KEY, ResourceLocation.CODEC).fieldOf("loot_table_pool").forGetter(task -> task.lootTablePool),
            ...
            Codec.INT.optionalFieldOf("current_selected", 0).forGetter(task -> task.currentSelected)
    ).apply(instance, DynamicAnglerTradeTask::new));

    private final Map<Integer, List<ItemStack>> resultPool;
    private final Map<Integer, ResourceLocation> lootTablePool;
    ...
    public DynamicAnglerTradeTask(
            ...
            Map<Integer, ResourceLocation> lootTablePool,
    ...
    public static class Builder {
        ...
        private final Map<Integer, ResourceLocation> lootTablePool = new HashMap<>();
        ...
        public Builder addLootTable(int level, ResourceLocation lootTable) {
