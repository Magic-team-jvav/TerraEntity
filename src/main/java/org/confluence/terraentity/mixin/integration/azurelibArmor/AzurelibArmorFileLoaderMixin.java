package org.confluence.terraentity.mixin.integration.azurelibArmor;
...
@Pseudo
@Mixin(targets = "mod.azure.azurelibarmor.loading.FileLoader", remap = false)
// @Mixin(FileLoader.class)
public class AzurelibArmorFileLoaderMixin {
    ...
    private static String wrapToString(InputStream sw, Charset input, Operation<String> original,
